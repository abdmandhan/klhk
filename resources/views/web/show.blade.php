        ...
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    @csrf
                    @method('PUT')
                    <x-input type="text" name="name" label="Web Name" :value="$data->name" disabled />
                    ...
                    <x-input type="text" name="description" label="Description" :value="$data->description" disabled />
                    <x-input type="checkbox" name="status" label="Status" :value="$data->status" disabled />
                    <x-input type="text" name="image" label="Image Url" :value="$data->image" disabled />
                </div>
                <div class="card-footer">
                    <a href="{{ route('web.edit',$data->id) }}" class="btn btn-success">Edit</a>
                </div>
            </div>
        </div>
    </div>
