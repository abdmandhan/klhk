      ...
      <div class="container">
        <div class="row mb-5 justify-content-center">
          <div class="col-md-7 text-center">
            <h2 class="section-title mb-3" data-aos="fade-up" data-aos-delay="">Daftar Sistem Internal</h2>
            <p class="lead" data-aos="fade-up" data-aos-delay="100">Daftar Sistem Internal yang ada di Kementerian Lingkungan Hidup dan Kehutanan Indonesia</p>
          </div>
        </div>
  <div class="pb-5">
    <div class="container">
              ...
              <thead>
                <tr>
                  <th scope="col" class="border-0 bg-light">
                    <div class="p-2 px-3 text-uppercase">Sistem Internal</div>
                  </th>
                  <th scope="col" class="border-0 bg-light">
