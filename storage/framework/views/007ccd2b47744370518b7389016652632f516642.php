        ...
        <nav class="main-header navbar <?php echo e(config('adminlte.classes_topnav_nav', 'navbar-expand-md')); ?> <?php echo e(config('adminlte.classes_topnav', 'navbar-white navbar-light')); ?>">
            <div class="<?php echo e(config('adminlte.classes_topnav_container', 'container')); ?>">
                <?php if(config('adminlte.logo_img_xl')): ?>
                    <a href="<?php echo e($dashboard_url); ?>" class="navbar-brand logo-switch">
                        <img src="<?php echo e(asset(config('adminlte.logo_img', 'vendor/adminlte/dist/img/logoklhk.png'))); ?>" alt="<?php echo e(config('adminlte.logo_img_alt', 'AdminLTE')); ?>" class="<?php echo e(config('adminlte.logo_img_class', 'brand-image-xl')); ?> logo-xs">
                ...
                <?php else: ?>
                    <a href="<?php echo e($dashboard_url); ?>" class="navbar-brand <?php echo e(config('adminlte.classes_brand')); ?>">
                        <img src="<?php echo e(asset(config('adminlte.logo_img', 'vendor/adminlte/dist/img/logoklhk.png'))); ?>" alt="<?php echo e(config('adminlte.logo_img_alt', 'AdminLTE')); ?>" class="<?php echo e(config('adminlte.logo_img_class', 'brand-image img-circle elevation-3')); ?>" style="opacity: .8">
                ...
                <div class="collapse navbar-collapse order-3" id="navbarCollapse">
                    <ul class="nav navbar-nav">
                        <?php echo $__env->renderEach('adminlte::partials.menu-item-top-nav-left', $adminlte->menu(), 'item'); ?>
                    </ul>
                </div>
            <?php else: ?>
            <nav class="main-header navbar <?php echo e(config('adminlte.classes_topnav_nav', 'navbar-expand-md')); ?> <?php echo e(config('adminlte.classes_topnav', 'navbar-white navbar-light')); ?>">
            ...
            <?php endif; ?>
                <ul class="navbar-nav ml-auto <?php if(config('adminlte.layout_topnav') || View::getSection('layout_topnav')): ?>order-1 order-md-3 navbar-no-expand <?php endif; ?>">
                    ...
                    <?php echo $__env->renderEach('adminlte::partials.menu-item-top-nav-right', $adminlte->menu(), 'item'); ?>
                    <?php if(Auth::user()): ?>
                        <?php if(config('adminlte.usermenu_enabled')): ?>
                        <li class="nav-item dropdown user-menu">
                            <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">
                                <?php if(config('adminlte.usermenu_image')): ?>
                                <img src="<?php echo e(Auth::user()->adminlte_image()); ?>" class="user-image img-circle elevation-2" alt="<?php echo e(Auth::user()->name); ?>">
                                <?php endif; ?>
                                <span <?php if(config('adminlte.usermenu_image')): ?>class="d-none d-md-inline"<?php endif; ?>><?php echo e(Auth::user()->name); ?></span>
                            </a>
                            <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                                <?php if(!View::hasSection('usermenu_header') && config('adminlte.usermenu_header')): ?>
                                <li class="user-header <?php echo e(config('adminlte.usermenu_header_class', 'bg-primary')); ?> <?php if(!config('adminlte.usermenu_image')): ?>h-auto <?php endif; ?>">
                                    <?php if(config('adminlte.usermenu_image')): ?>
                                    <img src="<?php echo e(Auth::user()->adminlte_image()); ?>" class="img-circle elevation-2" alt="<?php echo e(Auth::user()->name); ?>">
                                    <?php endif; ?>
                                ...
                                <?php endif; ?>
                                <?php echo $__env->renderEach('adminlte::partials.menu-item-top-nav-user', $adminlte->menu(), 'item'); ?>
                                ...
                                <li class="user-footer">
                                    <?php if($profile_url): ?>
                                    <a href="<?php echo e($profile_url); ?>" class="btn btn-default btn-flat">Profile</a>
                                    <?php endif; ?>

                                    <a class="btn btn-default btn-flat float-right <?php if(!$profile_url): ?>btn-block <?php endif; ?>" href="#" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
...
<?php echo $__env->make('adminlte::master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\klhk\vendor\jeroennoten\laravel-adminlte\src/../resources/views/page.blade.php ENDPATH**/ ?>