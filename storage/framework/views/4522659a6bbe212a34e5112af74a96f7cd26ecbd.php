...
<div class="site-blocks-cover" style="background-image: url('<?php echo e(asset('vendor/client/images/hero_2.jpg')); ?>');" id="home-section">
...
<!-- <div class="container"> -->
  ...
  <div class="row">
    <div class="col-lg-6 mb-5" data-aos="fade-up" data-aos-delay="">
      ...
      <img src="<?php echo e(url('vendor/client/images/'.$tentang->gambar)); ?>" alt="Free Website Template by Free-Template.co" class="img-fluid">
      </figure>
    </div>
...
<div class="container">
  ...
  <div class="row">
    <?php $__currentLoopData = $web; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $a): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <div class="col-md-6 col-lg-4 mb-4 mb-lg-4" data-aos="fade-up" data-aos-delay="">
      <div class="h-entry">
        <a href="single.php">
          <img src="<?php echo e(asset('vendor/client/images/').'/'.$a->image); ?>" alt="Image" class="img-fluid">
        </a>
        <h2 class="font-size-regular"><a href="#"><?php echo e($a->name); ?></a></h2>
        <?php $nama_kategori = DB::table('web_categories')->where('id', $a->id_web_category)->first();?>
        <div class="meta mb-4"><?php echo e($nama_kategori->name); ?> <span class="mx-2">&bullet;</span> <span class="mx-2">&bullet;</span> 
        <?php if ($a->status == 1) {
            $name_status = "Aktif";
          }else{
            $name_status = "Tidak Aktif";
          }?>
        <a href="#"><?php echo e($name_status); ?></a></div> <div style="white-space: nowrap; width: 295px; overflow: hidden; text-overflow: ellipsis;"><p><?php echo e($a->description); ?>

        <!-- di dalamnya terdapat informasi seputar KSDAE, seperti profil, sejarah, berita -->
        </p></div>
        <p><a href="<?php echo e(url('/front/ppid').'/'.$a->id); ?>">Baca Selanjutnya...</a></p>
      </div> 
    </div>
...
<?php /**PATH C:\xampp\htdocs\klhk\resources\views/client/home.blade.php ENDPATH**/ ?>