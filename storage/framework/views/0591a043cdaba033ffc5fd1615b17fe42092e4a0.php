        ...
        <div class="col-md-10">
            <div class="card-header">
                ...
                <div class="card-tools">
                    <a href="<?php echo e(url('/edit/admin')); ?>"class="btn btn-primary">Tambah Data Admin</a>
                </div>
            </div>
            <div class="card-body">
                            ...
                            <td>
                                 <form action="#" method="POST">
                                    ...
                                    <button type="submit" class="btn btn-link" title="Delete"
                                        onsubmit="confirm('Delete web <?php echo e($a->name); ?> ?')"><i
...
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\klhk\resources\views/profil/index.blade.php ENDPATH**/ ?>