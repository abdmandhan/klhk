...
class UserManagementController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect(route('user-management.index'))->with('success', 'Berhasil membuat user');;
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect(route('user-management.index'))->with('success', 'Berhasil update data');
    }
